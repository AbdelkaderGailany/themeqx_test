        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                @if( ! empty($title))
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">أضافة اعلان </h1>
                        </div> <!-- /.col-lg-12 -->
                    </div> <!-- /.row -->
                @endif
                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12">
                        ...
                        <legend>معلومات الاعلان</legend>

                        <div class="form-group  {{ $errors->has('category')? 'has-error':'' }}">
                            <label for="category_name" class="col-sm-4 control-label">القسم</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('ad_title')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">عنوان الأعلان</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ad_title" value="{{ old('ad_title') }}" name="ad_title" placeholder="">
                                {!! $errors->has('ad_title')? '<p class="help-block">'.$errors->first('ad_title').'</p>':'' !!}
                            </div>
                        </div>

                        <div class="form-group {{ $errors->has('ad_description')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">وصف الأعلان</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('condition')? 'has-error':'' }}">
                            <label for="condition" class="col-sm-4 control-label">الحالة</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group  {{ $errors->has('price')? 'has-error':'' }}">
                            <label for="price" class="col-md-4 control-label">السعر</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group {{ $errors->has('video_url')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">رابط فيديو يوتيوب</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="video_url" value="{{ old('video_url') }}" name="video_url" placeholder="">
                                {!! $errors->has('video_url')? '<p class="help-block">'.$errors->first('video_url').'</p>':'' !!}
                            </div>
                        </div>


                        <legend>معلومات الموقع</legend>

                        <div class="form-group  {{ $errors->has('country')? 'has-error':'' }}">
                            <label for="category_name" class="col-sm-4 control-label">المحافظة</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('city')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">المنطقة</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="city_select" value="" name="city" placeholder="">
                        ...
                        <div class="form-group {{ $errors->has('seller_name')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">اسم البائع</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="seller_name" value="{{ old('seller_name')? old('seller_name') : $lUser->name }}" name="seller_name" placeholder="">
                        ...
                        <div class="form-group {{ $errors->has('seller_email')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">بريد الألكتروني للبائع</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('seller_phone')? 'has-error':'' }}">
                            <label for="ad_title" class="col-sm-4 control-label">رقم الهاتف</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->has('address')? 'has-error':'' }}">
                            <label for="address" class="col-sm-4 control-label">عنوان البائع</label>
                            <div class="col-sm-8">
...
-->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <button type="submit" class="btn btn-primary">حفظ الاعلان </button>
                            </div>
                        </div>
                        </form>
