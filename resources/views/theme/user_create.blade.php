    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                ...
                <div class="login">
                    <h3 class="authTitle">انشاء حساب <a href="{{ route('login') }}" class="btn btn-xl btn-default">تسجيل الدخول</a></h3>
                    ...
                    <form action="{{route('user.store')}}" role="form" method="post"> @csrf
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group {{ $errors->has('first_name')? 'has-error':'' }} ">
                                    <input type="text" name="first_name" id="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="الأسم الأول" tabindex="1">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group {{ $errors->has('last_name')? 'has-error':'' }} ">
                                    <input type="text" name="last_name" id="last_name" class="form-control"  value="{{ old('last_name') }}" placeholder="أسم العائله" tabindex="2">
                        ...
                        <div class="form-group {{ $errors->has('email')? 'has-error':'' }} ">
                            <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="البريد الألكنروني" tabindex="4">
					...
					<span class="button-checkbox">
						<label><input type="checkbox" name="agree" value="1" /> اوافق </label>
					</span>
                            </div>
                        ...
                        <hr />
                        <div class="row">
                            <div class="col-xs-12"><input type="submit" value="أنشاء الحساب"  class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
                        </div>
                    </form>
