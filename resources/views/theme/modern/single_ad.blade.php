            ...
            <div class="row">
                <div class="modern-single-ad-top-description">
                    ...
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <h3>معلومات عامة</h3>
                        <p><strong><i class="fa fa-money"></i> السعر</strong> {{ themeqx_price_ng($ad->price) }} </p>
                        <p><strong><i class="fa fa-map-marker"></i>  العنوان </strong> {!! $ad->full_address() !!} </p>
                        <p><strong><i class="fa fa-check-circle-o"></i> الحالة</strong> {{ $ad->ad_condition }} </p>
        ...
        <div class="row">
            <div class="col-sm-8 col-xs-12">
                <div class="ads-detail bg-white">
                    <h4 class="ads-detail-title">صندوق الوصف</h4>
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="sidebar-user-link">
                        <button class="btn btn-block" id="onClickShowPhone">
                            ...
                            <span class="text-muted">اضغط لإظهار الرقم</span>
                        </button>

                        @if($ad->user->email)
                            <button class="btn btn-block" data-toggle="modal" data-target="#replyByEmail">
                                <i class="fa fa-envelope-o"> الرد عن 
                                طريق الاميل</i>
                            </button>
                        @endif

                        <ul class="ad-action-list">
                            <li><a href="{{ route('listing', ['user_id'=>$ad->user_id]) }}"><i class="fa fa-user"></i> اعلانات اخرى لنفس البائع</a></li>
                            <li><a href="javascript:;" id="save_as_favorite" data-slug="{{ $ad->slug }}">
                                    @if( ! $ad->is_my_favorite())
                                        <i class="fa fa-star-o"></i> اضافة الى قائمة المفضلة
                                    @else
                                        <i class="fa fa-star"></i> الغاء من المفضلة
                                    @endif
                                </a></li>
                            <li><a href="#" data-toggle="modal" data-target="#reportAdModal"><i class="fa fa-ban"></i> الإبلغ عن هذا الإعلان</a></li>
                        </ul>
