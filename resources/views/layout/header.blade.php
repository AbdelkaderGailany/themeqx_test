    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @if( ! Auth::check())
                    <li><a href="{{ route('login') }}"> <i class="fa fa-lock"></i> تسجيل الدخول </a>  </li>
                    <li><a href="{{ route('user.create') }}"> <i class="fa fa-save"></i>  انشاء حساب </a></li>
                @endif
                <li><a href="{{ route('create_ad') }}"> <i class="fa fa-tag"></i> اضافة اعلان</a></li> 
            </ul>
        </div><!--/.navbar-collapse -->
    </div>
</nav>
